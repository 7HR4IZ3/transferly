...
4. The receiver scans the sender's QR code.
5. The sender scans the receiver's reply QR code.
6. Keep both transfer screens open until the files finish.
...
- If camera scanning is unavailable, open the text-code fallback inside the pairing screen.
